Scriptname IMPScriptCaravanguardAlias extends ReferenceAlias

Event OnLoad()
	IMPScriptMain IMP=Game.GetFormFromFile(0x01000F9B, "IMP.esp") as IMPScriptMain
	IMP.CaravanManager.CaravanguardAliasOnLoad(GetReference())
EndEvent
...
Event OnCellDetach()
	IMPScriptMain IMP=Game.GetFormFromFile(0x01000F9B, "IMP.esp") as IMPScriptMain
	IMP.CaravanManager.CaravanguardAliasOnUnload(GetReference())
EndEvent